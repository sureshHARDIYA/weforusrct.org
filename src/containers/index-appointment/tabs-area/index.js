...
import Tabs, {TabHeader, NavItem, TabContent, TabPane} from '../../../components/ui/tabs'
...
const TabsSection = ({sectionStyles, sectionTitleStyle}) => {
    ...
    query TabsSecQuery {
        appointmentJson(id: {eq: "appointment-about-us"}) {
            id
            title
            subtitle
            tab_header {
    ...
    const secdata = tabsSecQueryData.appointmentJson;
